...
class NeuralNetwork:
   ...
   def cost(self, data, output, weight_decay = 0.01):
      """
   ...
   def train_batch(self, data, output, learning_rate = 0.1, convergence = 0.0001, maxEpochs = 10000, weight_decay = 0.01):
      """
      ...
      while self.cost(data, output, weight_decay) > convergence and epoch < maxEpochs:
         print "Epoch", epoch, "- Cost:", self.cost(data, output, weight_decay)
         epoch+=1
   ...
   def train_minibatch(self, data, output, learning_rate = 0.1, convergence = 0.0001, maxEpochs = 10000, numBatches = 10, weight_decay = 0.01):
      """
      Perform batch training using the provided data and labels
      """
